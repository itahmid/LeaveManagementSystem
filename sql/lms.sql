-- ---------------------------------------------------
-- LeaveManagementSystem Database Schema definition
-- 
...
(1, 'Tahmid', 'Ikhlas', 'itahmid', 'tahmid.ikhlas@gmail.com', '$2a$08$LeUbaGFqJjLSAN7to9URsuHB41zcmsMBgBhpZuFp2y2OTxtVcMQ.C', 8, 1, NULL, 0, NULL, 1, '2017-07-01', 'PNC0025', 'en');
